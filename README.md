...
- 🧭 **Vault 治理 Skill**：`brain-vault-governance` 帮 Agent 判断计划、prompt、知识、任务和原始资产该放哪里
- 🚀 **一键安装**：`bash setup.sh`
...
- [Vault 治理 Skill](skills/brain-vault-governance/README.md)
- [治理同步边界](docs/governance-sync-boundary.md) / [中文版](docs/zh/governance-sync-boundary.md)
- [发版与版本号指南](docs/release-versioning.md) / [中文版](docs/zh/release-versioning.md)
