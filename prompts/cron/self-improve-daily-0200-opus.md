---
name: self-improve-daily-0200-opus
schedule: "0 2 */2 * *"
agent: opus
model: default
enabled: false
description: 每天02:00自我反思与微进化（opus）
delivery_mode: announce
---

# self-improve-daily-0200-opus
...
- {{USER_HOME}}/Documents/ZeYu-AI-Brain/13-DAILY-LOG/2026/03/ 最近2天的 daily log（重点关注与 opus 相关的事件与反馈）
- 最近会话关键回执（聚焦错误/回滚/误判）
