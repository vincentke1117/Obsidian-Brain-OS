---
name: self-improve-daily-0200-review
schedule: "0 2 */2 * *"
agent: review
model: default
enabled: false
description: 每日02:00自进化反思 + 全 workspace dirty repo 检查
delivery_mode: announce
---

# self-improve-daily-0200-review
...
- {{USER_HOME}}/Documents/ZeYu-AI-Brain/13-DAILY-LOG/2026/03/ 最近2天的 daily log（重点关注与 review 相关的事件与反馈）
- 最近会话关键回执（聚焦错误/回滚/误判）
